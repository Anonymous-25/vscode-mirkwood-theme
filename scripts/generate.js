 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} mirkwood - mirkwood color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.mirkwood.ansi, ...soft.mirkwood.brightOther];
...
module.exports = async () => {
    const yamlFile = await readFile(
        join(__dirname, '..', 'src', 'mirkwood.yml'),
        'utf-8'
    );
